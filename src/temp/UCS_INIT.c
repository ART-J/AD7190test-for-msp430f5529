 ...
 *      Author: yumin
 *
 *系统默认：ACLK使用REFOCLK=32.768KHz,MCLK和SMCLK使用DCOCLKDI,V=1.048576MHz
 *本程序    ：ACLK使用X1晶振=32.768KHz,MCLK使用X2晶振=25MHz，SMCLK使用DCOCLKDIV=4MHz
 */
...
/************************************************等待晶振起振*/
    ...
    UCSCTL4=(UCSCTL4&(~(SELA_7|SELS_7|SELM_7)))|SELA_0|SELS_5|SELM_3;
       ...
       //ACLK->X1COK(32.768KHz),SMCLK->X2CLK(4MHz),MCLK->DCOCLK(24.969MHZ)
}
